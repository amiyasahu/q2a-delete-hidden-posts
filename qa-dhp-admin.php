	...
	class qa_dhp_admin {
		...
		//	Process form input
			...
			if (qa_clicked(self::SAVE_BTN)) {
				...
				$ok = qa_lang('ami_dhp/all_hidden_posts_deleted') ;
		...
		//	Create the form for display_header_text();
			...
			$fields[self::PLUGIN_ENABLED] = array(
				'label' => qa_lang('ami_dhp/dhp_enable'),
			...
			$fields[self::SAME_USER_CAN_DELETE_QA] = array(
				...
				'label' => qa_lang('ami_dhp/same_user_can_delete'),
				'type'  => 'checkbox',
			...
			$fields[self::MIN_LEVEL_TO_DELETE_Q] = array(
				...
				'label'   => qa_lang('ami_dhp/choose_who_can_delete_all'),
				'type'    => 'select',
			...
			return array(
				...
				'buttons' => array(
					...
					array(
					'label' => qa_lang('ami_dhp/delete_hidden_posts'),
